...
class Module {
	constructor() {
		this.api_url = 'https://windsaloft.us/winds_openmeteo.php?lat=' + document.config.location.lattitude + '&lon=' + document.config.location.longitude + '&hourOffset=' + document.config.windsaloft.hourOffset + '&referrer=MSWA20>
